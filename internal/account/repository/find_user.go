...
func (ur *userRepository) FindUserByEmail(
	...
	if err != nil {
		if err == mongo.ErrNoDocuments {
			...
			return nil, httperr.NewNotFoundError(errorMessage)
		}
		...
		return nil, httperr.NewInternalServerError(errorMessage)
	}
...
func (ur *userRepository) FindUserByEmailAndPassword(
	...
	if err != nil {
		if err == mongo.ErrNoDocuments {
			...
			return nil, httperr.NewForbiddenError(errorMessage)
		}
